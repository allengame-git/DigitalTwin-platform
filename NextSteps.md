...
**最後更新**: 2026-03-06（手動觸發動畫播放 UI A2 + 動畫預覽路徑可視化 A4）
...
| 檔案 | 說明 |
|:-----|:-----|
| `src/stores/facilityStore.ts` | **設施導覽**（場景樹/模型管理/多選/批次操作/編輯模式/動畫模式/播放控制/關鍵幀 CRUD/手動播放控制/模組層級 ref 註冊） |
