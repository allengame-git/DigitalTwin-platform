...
### SEC2. API 路由認證策略統一（對應 I3）— 部分完成

**已完成**: facility 模組所有 GET 路由（scenes/models/info/animations）已加 `authenticate`（I4-NEW）。
...
| 18b | 其他模組 GET 路由無認證 | 中 | I3：borehole/terrain/geology-model 等仍公開 |
